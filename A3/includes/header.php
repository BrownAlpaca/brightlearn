    		    ...
    		    if($_SESSION["status"]=="login"){
                    if($_SESSION["type"]=="2"){
                        ...
                        echo'><a class="nav-link" href="index.php" >Home</a>
                            ...
                            echo '><a class="nav-link" href="my-courses.php" >My course</a>
                            </li>
                            <li'; 
                            if($pageTitle == 'report')
                            { echo ' class="nav-item active"';
                                ...
                                echo ' class="nav-item"';}
                        echo'><a class="nav-link" href="report.php" >Report issue</a>
                            </li>
                            <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Course Posts                          
                              </a>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">detail1</a>
                                <a class="dropdown-item" href="#">detail2</a>
                              </div>
                            </li>
                            <li class="nav-item dropdown">
